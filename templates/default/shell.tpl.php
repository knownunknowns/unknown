...
//adds a page class to the page
    ...
    //adds logged in/logged out classes
    if (\Idno\Core\Idno::site()->session()->isLoggedIn()) {
        echo ' logged-in';
    } else {
        echo ' logged-out';
...
?>">
    <div class="pageWrap">
        <?php
        //add get the current page info
            $currentPage = \Idno\Core\Idno::site()->currentPage();

        //hide the nav bar if on home page and embeded
        ...
        //draw the stuff that comes before the container
